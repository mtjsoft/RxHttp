...
public class FileDownloader {
     ...
     */
    public static void downloadFile(Observable<ResponseBody> observable, LifecycleProvider lifecycle,
                                    final String destDir, final String fileName, final DownloadProgressHandler progressHandler) {
...
//                        addDisposable(d);
     ...
     */
    public static void downloadFile2(Observable<ResponseBody> observable, LifecycleProvider lifecycle,
                                     final String destDir, final String fileName, final DownloadProgressHandler progressHandler) {
        final DownloadInfo downloadInfo = new DownloadInfo();
        observable
                .compose(lifecycle.bindToLifecycle())
